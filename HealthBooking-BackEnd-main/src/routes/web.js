...
let initWebRoutes = (app) => {
  ...
  // Api laasy tgian da dat
  router.get(
    "/api/get-time-booking-by-date",
    doctorController.getTimeBookingByDate
  );
  // //////////////////////////////////////////////////
  router.get(
  ...
  router.put("/api/edit-specialty/:id", specialtyControler.handleEditSpecialty);
  router.delete(
  ...
  router.put(`/api/cancle-booking/:id`, patientController.handleCancleBooking);
  ...
  router.get(`/api/get-doctor-rating`, patientController.handleGetDoctorRating);
