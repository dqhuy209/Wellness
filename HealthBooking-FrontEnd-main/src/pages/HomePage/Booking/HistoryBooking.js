...
class HistoryBooking extends Component {
  ...
  handleCancelBooking = async (data) => {
    const { token } = this.props;
    var isConfirmed = window.confirm("Bạn có chắc chắn hủy lịch này không?");
    ...
    const columnsLookUp = [
      ...
      // },
      {
        ...
        render: (text, record) => {
          return (
            <span
              className={`status-column ${getStatusColor(record.statusId)}`}
            >
              {record.status}
            </span>
          );
      ...
      <>
        ...
        <div className="booking-history-container">
          <div className="booking-history-header">
            ...
            <div>
              <FormattedMessage
                id={"patient.appointment-schedule.text-appointment-schedule"}
              />
            </div>
          </div>
          {isLoggedIn === false ? (
            <>
              ...
              <div className="booking-history-content">
                <div className="booking-current">
                  <h2>
                    <FormattedMessage
                      id={"patient.appointment-schedule.text-title-lookup"}
                    />
                  </h2>
                  {lookUpBooking && lookUpBooking.length > 0 ? (
                    <Table
                    ...
                    <p className="text-center">
                      <FormattedMessage
                        id={"patient.appointment-schedule.text-result"}
                      />
                    </p>
                  )}
                </div>
            ...
            <>
              <div className="booking-history-content">
                <div className="booking-current">
                  ...
                  <Table dataSource={this.state.bookings} columns={columns} />
                </div>
                <div className="booking-history">
                  <h2>
                    <FormattedMessage
                      id={"patient.appointment-schedule.text-title-history"}
                    />
                  </h2>
                  <Table
