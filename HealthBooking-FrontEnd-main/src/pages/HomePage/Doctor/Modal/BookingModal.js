...
//   }
//   componentDidMount() {
//     // Kiểm tra trạng thái nút đã lưu trong local storage hay chưa
//     const bookingButtonStatus = localStorage.getItem("bookingButtonStatus");
//     // const urlParams = new URLSearchParams(window.location.search);
//     // const bookingStatus = urlParams.get('bookingStatus');
//     if (bookingButtonStatus === "booked") {
//       // Nếu trạng thái là đã đặt lịch, cập nhật nút
//       this.setState({
//         isOpenModal: true,
//       });
//     }
...
//         return {
//           lable: language === LANGUAGE.VI ? item.valueVi : item.valueEn,
//           value: item.keyMap,
//         };
//       });
//     }
...
//       isValid = false;
//     } else if (calculateAge(this.state.birthDay) < 18) {
//       // Check trên 18 tuổi
//       copyState.error["birthDay"] = `Bạn phải trên 18 tuổi`;
//       isValid = false;
//     }
...
//           recaptchaValue: null,
//         });
//         // Reload trang sau khi đặt lịch thành công
//         // window.location.reload();
//         this.props.updateBookingStatus(this.props.dataTime.id, true);
//         localStorage.setItem("bookingButtonStatus", "booked");
//       } else {
//         this.props.isShowLoading(false);
...
//                     onChange={(event) =>
//                       this.handleChangeInput(event, "selectedGender")
//                     }
//                   >
//                     {genders &&
//                       genders.length > 0 &&
...
//                 </p>
//                 <p className="text-note">
//                   Thông tin anh/chị cung cấp sẽ được sử dụng làm hồ sơ khám chữa
...
//                 }}
//                 disabled={this.state.recaptchaValue ? false : true}
//               >
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    getUserInforPatient: () => dispatch(getUserInforPatient),
    getUserInforSystem: () => dispatch(getUserInforSystem),
  };
};
