...
class HomeHeader extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <div className={`home-header-container ${bgColor ? "bgColor" : ""}`}>
          <div className="home-header-content">
            ...
            <div className="center-content d-none d-lg-flex">
              <Link to={routes.LIST_SPECIALTY} className="child-content">
              ...
              <Link to={routes.LIST_CLINIC} className="child-content">
                <div>
                  <b>
              ...
              <Link to={routes.LIST_DOCTOR} className="child-content">
                <div>
                  <b>
            ...
            <div className="right-content">
              <div className="right_content-container">
                {/* <Link className="booking" to={routes.HISTORY_BOOKING}>
                  <FontAwesomeIcon
                ...
                >
                  <span
                    onClick={() => {
                      this.props.changeLanguage(LANGUAGE.VI);
                    }}
                  >
                    VN
                  </span>
                ...
                >
                  <span
                    onClick={() => {
                      this.props.changeLanguage(LANGUAGE.EN);
                    }}
                  >
                    EN
                  </span>
        ...
        {isShowBanner && (
          <div className="home-header-banner">
            <div className="search">
              ...
              <div className={`search-form ${isFocused ? "hien" : ""}`}>
                <div className="search-input">
                  ...
                  <input
                    ...
                    type="text"
                    placeholder={
                      language === LANGUAGE.VI ? "Tìm kiếm" : "Search"
                    }
                    onFocus={() => {
                    ...
                    onChange={(e) => {
                      this.handleOnChangeSearch(e, "searchQuery");
                    }}
                    onKeyPress={(e) => {
                ...
                <div className="search-result">
                  <div className="search-result_specialties">
                    ...
                    {listSearchSpecialty &&
                      ...
                      listSearchSpecialty.map((item, index) => {
                        return (
                          <Link to={`/detail-specialty/${item.id}`} key={index}>
                            <div
                              className="image"
                              style={{
                  ...
                  <div className="search-result_clinics">
                    ...
                    {listSearchClinic &&
                      ...
                      listSearchClinic.map((item, index) => {
                        return (
                  ...
                  <div className="search-result_doctors">
                    ...
                    {listSearchDoctor &&
                      ...
                      listSearchDoctor.map((item, index) => {
                        return (
                          <Link to={`/detail-doctor/${item.id}`} key={index}>
                            <div
                              className="image"
                              style={{
                                backgroundImage: `url(${item.image})`,
