    ...
    const renderTopDoctor = () => {
      return this.state.arrDoctors.map((doctor, index) => {
        ...
        if (doctor.User.image) {
          ...
          imageBase64 = new Buffer(doctor.User.image, "base64").toString(
            "binary"
          );
        }
              ...
              <div className="description text-center">
                ...
                <span>
                  {language === LANGUAGE.VI
                    ? doctor.User.Doctor_Infor.specialtyData.nameVi
                    : doctor.User.Doctor_Infor.specialtyData.nameEn}
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="section-share section-doctor">
        <div className="section-container">
          <div className="section-header">
            ...
            <Link to={`/danh-sach/bac-si/danh-cho-ban`} className="btn-section">
