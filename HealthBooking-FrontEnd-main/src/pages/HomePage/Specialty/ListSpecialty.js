    ...
    return (
      <>
        <Helmet>
          ...
          <meta name="description" content={`Danh sách chuyên khoa`} />
        </Helmet>
        ...
        <div className="list-specialty_container">
          <div className="list-specialty-header">
            ...
            <div>
              <FormattedMessage id={"patient.list-speciality.text-title"} />
            </div>
          </div>
          <div className="list-specialty_search">
            ...
            <div className="filter_search">
              ...
              <button>
                <FormattedMessage id={"patient.list-speciality.text-search"} />
              </button>
            </div>
          </div>
