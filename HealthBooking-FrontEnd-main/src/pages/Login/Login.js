...
class Login extends Component {
  ...
  handleLogin2 = async (e) => {
    ...
    try {
      ...
      let res = await handleLoginApi2(this.state.userName, this.state.passWord);
      if (res && res.errCode !== 0) {
          ...
          <div className="login-container col-6">
            <div className="login-content row">
              ...
              <div className="col-12 form-group">
                <label>
                  <FormattedMessage id={"patient.login.userName"} />
                </label>
                <input
                  type="text"
              ...
              <div className="col-12 form-group login-input">
                <label>
                  <FormattedMessage id={"patient.login.passWord"} />
                </label>
              ...
              <div className="col-12">
                ...
                >
                  <FormattedMessage id={"patient.login.login"} />
                </button>
              </div>
              <div className="col-12 forgot-password">
                <Link to={configs.routes.REGISTER}>
                  <FormattedMessage id={"patient.login.register"} />
                </Link>
              </div>
              <div className="col-12">
                <span className="forgot-password">
                  <FormattedMessage id={"patient.login.forgot"} />
                </span>
              </div>
              <div className="col-12 text-center mt-3">
                <span className="text-other-login ">
                  <FormattedMessage id={"patient.login.other-app"} />
                </span>
              </div>
