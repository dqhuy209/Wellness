...
class Register extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.gendersFromRedux !== this.props.gendersFromRedux) {
      ...
      this.setState({
        genders: genders,
        gender:
          this.props.gendersFromRedux && this.props.gendersFromRedux.length > 0
  ...
  handleRegister = async (e) => {
    ...
    if (calculateAge(formattedBirthDay) < 18) {
      toast.warn("Bạn phải đủ 18 tuổi để đăng ký!");
      return;
    }
    let data = {
      email: email,
        ...
        <div className="register-container d-flex">
          <div className="col-md-6 register-content container">
            <div className="row justify-content-center align-items-center w-100">
              {/* <div className="Logo mb-lg-5 mb-sm-2">
                    <img
              ...
              <div className="card">
                <div className="card-header">
                  <h3 className="text-center title">
                    <FormattedMessage id={"patient.register.title"} />
                  </h3>
                </div>
                  ...
                  <form className="row">
                    <div className="mb-lg-3 col-12">
                      <label htmlFor="email" className="form-label">
                        <FormattedMessage id={"patient.register.email"} />
                      </label>
                      <input
                        type="email"
                    ...
                    <div className="mb-lg-3 col-sm-12 col-md-12 col-lg-6">
                      <label htmlFor="passWord" className="form-label">
                        <FormattedMessage id={"patient.register.passWord"} />
                      </label>
                      <input
                        type="password"
                        className="form-control"
                    ...
                    <div className="mb-lg-3 col-sm-12 col-md-12 col-lg-6">
                      <label htmlFor="confirmPassword" className="form-label">
                        <FormattedMessage id={"patient.register.confirm"} />
                      </label>
                      <input
                        type="password"
                        className="form-control"
                    ...
                    <div className="mb-lg-3 col-sm-12 col-md-12 col-lg-6">
                      <label htmlFor="firstName" className="form-label">
                        <FormattedMessage id={"patient.register.firstName"} />
                      </label>
                      <input
                        type="text"
                        className="form-control"
                    ...
                    <div className="mb-lg-3 col-sm-12 col-md-12 col-lg-6">
                      <label htmlFor="lastName" className="form-label">
                        <FormattedMessage id={"patient.register.lastName"} />
                      </label>
                      <input
                        type="text"
                        className="form-control"
                    ...
                    <div className="mb-lg-3 col-sm-12 col-md-12 col-lg-6">
                      <label htmlFor="phoneNumber" className="form-label">
                        <FormattedMessage id={"patient.register.phoneNumber"} />
                      </label>
                      <input
                        type="tel"
                        className="form-control"
                    ...
                    <div className="col-12">
                      ...
                      >
                        <FormattedMessage id={"patient.register.register"} />
                      </button>
                    </div>
                  </form>
                </div>
