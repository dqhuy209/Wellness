    ...
    if (authorizeUser && authorizeUser.errCode === 0) {
      ...
      if (res && res.errCode === 0) {
        if (res && res.data && res.data.length > 0) {
          ...
          let countsCancle = res.data.map((entry) => entry.countsCancle);
          ...
          const data = {
            ...
            datasets: [
              ...
              {
                label: `${
                  language === LANGUAGE.VI ? "Lịch đặt" : "Appointment number"
                }`,
                data: counts,
    ...
    if (prevProps.language !== this.props.language) {
        ...
        if (res && res.data && res.data.length > 0) {
          ...
          const data = {
            ...
            datasets: [
              ...
              {
                label: `${
                  language === LANGUAGE.VI ? "Lịch đặt" : "Appointment"
                }`,
                data: counts,
                backgroundColor: "rgba(53, 162, 235, 0.5)",
                hoverBackgroundColor: "rgba(53, 162, 235, 1)",
      ...
      if (resClinicBooking && resClinicBooking.errCode === 0) {
        ...
        const data = {
          ...
          datasets: [
            {
              label: `${language === LANGUAGE.VI ? "Lịch đặt" : "Appointment"}`,
              data: countsBooking,
              backgroundColor: "rgba(53, 162, 235, 0.5)",
            },
          ],
          ...
          <div className="admin-home">
            ...
            >
              ...
              <DashboardCard
                ...
                title={language === LANGUAGE.EN ? "Clinic" : "Phòng khám"}
